...
#   if "subnet4" in each_dict:
    csvlist.append(f'{each_dict["name"]},{each_dict["ipv4-address-first"]},{each_dict["ipv4-address-last"]},{each_dict["domain"]["name"]},{each_dict["type"]},\n')
