from class_module_calculator_042 import calculator

'''
first object created with two values
and this object uses adder and multiplier
'''
calculator5=calculator(5,2)
print(calculator5.adder())
print(calculator5.multiplier())

'''
second object craeted with two values
and this objects divider and power
two completely different functions
'''
calculator6=calculator(4,2)
print(calculator6.divider())
print(calculator6.power())

'''
Benifit is, data is different between two objects.
Security of data is acheived using this.
Functions are also different on two objects and
the data inside it. Keeping the two types of methods
applied to the data separate.
'''
