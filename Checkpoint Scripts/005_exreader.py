...
for col in (cols):
    ...
    #  if(cvalue != None):
        ...
        if(cvalue != None and cvalue.find("any") == -1):
            ...
            if re.search("(?i)accept|deny|any",cvalue):
                #actionwm=[]
                actionwm=re.findall(r'(?i)accept|deny|any',cvalue)
                if actionwm:
...
print(f"celldict_unfmtd out of the loop after filling up data and replacements is :")
# dictprinter(celldict_unfmtd)
...
print("==========================================================================")
print("Formatting the data in celldict ")
print("==========================================================================")
...
for ips in iplist_nondup:
    ...
    if ips_with_commas not in objectsfile_string:
        # print(f"=====================================================================================================")
        # print(f"\n{ips} , requested host object doesnt exist ##############################")
    ...
    for eachline in objectsfile_list:
        ...
        if ips_with_commas in eachline:
            ...
            # print(f"==========================================================================")
                ...
                # local_host_object_list.append(eachline.split(",")[1])
...
print("=================================================")
print("Local Host objects currently present in local DB are ..")
...
print(f"#################### Unformated dictionary final value #################")
print(f"########################################################################")
...
def group_dict_formatter(the_dict): 
    ...
    print(f"  <<<<<<< Your formatted dictionary >>>>>>>>>> ")
    ...
    for l1keys,l1values in the_formatted_dict.items():
        ...
        for eachlist in list_of_lists:
            ...
            if isinstance(eachlist, list):
                ...
                final_string="add group name"+" "+eachlist[0]+' color "forest green"'+" "+member_string
...
#lmt1: existing networks cnanot be replaced.
#lmt2: mixing of networks/ips ips/fqdns doesnt work currently.
#lmt3: negate will only work for the object_name rather than ip i.e 1.1.1.1 will not work but h-1.1.1.1 will as it already exists
#at the time of the rule creation`
#lmt5: it cannot create the groups yet.
#lmt6: script cannot add hosts to group yet.
#lmt7: script still takes static fw name
#lmt8: script still takes static comments
#bug1: "any" is not being picked up by the script as port.
